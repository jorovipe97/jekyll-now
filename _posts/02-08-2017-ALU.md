...
El circuito puede parecer *"sin sentido entendible"* o *"una mera abstracción practica"* pero en esta caso la conexión de los chips dentro del **full-adder** sigue un orden que se explicara a continuación:
