...
Se inventara la siguiente sintazis en el lenguaje de ensamblador para este tipo de instrucciones
...
```
![](https://imgur.com/1fnHy3l.gif)
Este mismo enfoque se siguio para setear el registro A.
