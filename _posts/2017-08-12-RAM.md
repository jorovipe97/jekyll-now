...
En otras palabras, en un circuito combinacional, cuando cambia la entrada, cambia asincronamente del flanco de bajada la salida, en cambio en un circuito secuencial cuando cambian las entradas, la salida cambiara solo cuando ocurra el flanco de bajada (sincronicamente)
...
4. Cuando se cambia la entrada en un circuito combinacional su salida cambia asincronamente.
5. Cuando se cambia la entrada en un circuito secuencial su salida cambia en sincronizacion con el flanco de bajada.
