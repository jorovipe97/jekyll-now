...
- [Conocimientos importantes:](#conocimientos-importantes-)
  * [¿Porque es importante realizar en orden el proyecto? - concepto8a](#-porque-es-importante-realizar-en-orden-el-proyecto----concepto8a)
  * [HardwareSimulator y tecnicas para hacer debugging - concepto8b](#hardwaresimulator-y-tecnicas-para-hacer-debugging---concepto8b)
  * [Represantacion cananonica y sus implicaciones teoricas - concepto2-concepto3](#represantacion-cananonica-y-sus-implicaciones-teoricas---concepto2-concepto3)
  * [Simplificando función boleana - concepto4](#simplificando-funci-n-boleana---concepto4)
  * [Demostrando teoremas utilizando tablas de verdad - concepto5](#demostrando-teoremas-utilizando-tablas-de-verdad---concepto5)
    + [Absorption law AND form](#absorption-law-and-form)
    + [Absorption law OR form](#absorption-law-or-form)
    + [La ley de morgan AND form](#la-ley-de-morgan-and-form)
  * [La función Nand y sus superpoderes](#la-funci-n-nand-y-sus-superpoderes)
  * [Donde esta el bit menos significativo - concepto8d-concepto8e](#donde-esta-el-bit-menos-significativo---concepto8d-concepto8e)
  * [Pines desconectados - concepto8c](#pines-desconectados---concepto8c)
  * [Valor de los pines de entrada y salida - concepto8f](#valor-de-los-pines-de-entrada-y-salida---concepto8f)
    + [in:](#in-)
    + [out](#out)
    + [x](#x)
    + [y](#y)
  * [Orden de declaracion en HDL - concepto1](#orden-de-declaracion-en-hdl---concepto1)
...
- [Lista de chequeo y auto evaluación](#lista-de-chequeo-y-auto-evaluaci-n)
