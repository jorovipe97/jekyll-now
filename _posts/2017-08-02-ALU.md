...
Otra forma de hallar el complemento a 2 de un numero es mediante la siguiente formula:

![](https://wikimedia.org/api/rest_v1/media/math/render/svg/05d5c5d8787b89fad8cba9b41785e1806d10f2b3)

Donde:
- n es el numero de digitos binarios
- N el numero al cual queremos hallarle el complemento a 2

Veamos algunos ejemplos en los que vamos a hallar el complemento a 2 de varios numeros usando la tecnica anterior:

| Numero (N) | Numero de digitos (n) | 2^n - N | Binario de 2^n - N |
|------------|-----------------------|---------|--------------------|
| 1 | 8 | 
| 0
| -1
